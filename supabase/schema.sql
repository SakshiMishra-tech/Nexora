create table if not exists public.profiles (
  ...
  email text,
  college_name text,
  selected_spaces text[] not null default '{}',
...
alter table public.profiles
  ...
  add column if not exists selected_spaces text[] not null default '{}';
...
create policy "Roommate messages are visible to sender and receiver"
on public.roommate_messages
for select
